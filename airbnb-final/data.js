// This is data we take from our user and populate a similar but empty object.
export const formQuestionsData = [
    ...
    ,{
        id:2,
        title:"What kind of space will guest have ?",
        items:["An entire place","A private room","A shared room"]
    },{
        id:3,
        ...
        items:["Guests","Beds","Bedrooms","Bathrooms"],
    },{
        id:5,
...
//   return (
//     <div className='absolute w-[40rem] h-[40rem] left-[1rem] '>
...
//                         <label for="react-option" class="inline-flex justify-between items-center p-5 w-full text-gray-500 bg-white rounded-lg border-2 border-grayish cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-black hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
//                             <div class="block">
