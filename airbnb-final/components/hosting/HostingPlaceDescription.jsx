...
function HostingPlaceDescription({items,setResponse}) {
  return (
    ...
    <a key={index} href="#!" onClick={()=>{setResponse({title:item.title})}} className="block p-2 m-auto  w-[27rem] bg-white border-2 rounded-lg border-grayish hover:border-2 focus:border-black  hover:bg-gray-100">
