...
function HostingPlaceType({items,setResponse,setButtondisable}) {
  ...
  return (
     <div className='grid grid-cols-1 mt-10 gap-y-3'>
        {items.map(item=>
          <a href="#!" onClick={()=>setResponse({title:item.title})} className="m-auto p-0 w-[27rem] bg-gray-100 rounded-lg border-2 border-gray-200  hover:border-2 focus:border-black dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
