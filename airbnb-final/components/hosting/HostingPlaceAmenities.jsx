...
function HostingPlaceAmenities({items,setResponse}) {
  ...
  return (
    <div className='absolute flex flex-col w-[40rem] h-[40rem] left-[1rem] '>
      <div className='grid gap-4 m-[3rem] w-[35rem] md:grid-cols-3'>
      <div className='w-[11rem] h-[9rem]'>
        <input type="checkbox" id="abcd" className='hidden peer'/>
        <label for="abcd" class="inline-flex justify-between items-center h-full w-full text-gray-500 bg-white   border-x border-y rounded-md border-grayish cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-gray-300 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
        <div class="block">
            <div className='bg-fixed h-7 w-7' style="background-image:url(../../../../public/assets/icons/phone.gif))">
              helllo
            </div>
        </div>
          </label>
...
// <div className='absolute flex w-[40rem] h-[40rem] left-[1rem]  '>
// <div>
// {
//   items.map(item=>
//     <div>
